...
public class DataFilm{
    final ArrayList<dataMovies> arrMovie = new ArrayList<>();
    final ArrayList<dataShow> arrShow = new ArrayList<>();
    
    InputStreamReader isr = new InputStreamReader(System.in);
    BufferedReader br = new BufferedReader(isr);
    //Static method
    public static void clr() throws IOException, InterruptedException{
    ...
    void detailChangesMovie(String nama, int tahun, String direktor, String sinopsis, int panjangOrEpisode, int index){
        ...
        arrMovie.get(index).showChanges(tahun,"tahun");
        arrMovie.get(index).showChanges(direktor, "direktor");
        arrMovie.get(index).showChanges(panjangOrEpisode,"panjang");
    ...
    void detailChangesShow(String nama, int tahun, String direktor, String sinopsis, int panjangOrEpisode, int index){
        ...
        arrShow.get(index).showChanges(tahun,"tahun");
        arrShow.get(index).showChanges(direktor, "direktor");
        arrShow.get(index).showChanges(panjangOrEpisode,"jumlah");
