...
public abstract class DetailFilm {
    ...
    public abstract void addSucces();
    
    public abstract void showChanges(String dataSebelum,String type);
    
    public abstract void showChanges(int dataSebelum, String type);
...
final class dataMovies extends DetailFilm {
...
final class dataShow extends DetailFilm {
